...
function stateFromPayload(
  ...
  return {
    ...
    discoveryCategories: payload.discoveryCategories,
    discoverySubcategories: payload.discoverySubcategories,
    discoveryRarities: payload.discoveryRarities,
    discoveryRecords: payload.discoveryRecords,
    discoveryCollections: payload.discoveryCollections,
    discoveryChains: payload.discoveryChains,
    discoverySpawnProfiles: payload.discoverySpawnProfiles,
    discoverySpawnTables: payload.discoverySpawnTables,
    discoveryScanProfiles: payload.discoveryScanProfiles,
    discoveryCollectionProfiles: payload.discoveryCollectionProfiles,
    discoveryRewardProfiles: payload.discoveryRewardProfiles,
    discoveryStateDefinitions: payload.discoveryStateDefinitions,
    universalDiscoveryRegistry: payload.universalDiscoveryRegistry,
    universalObjectIdentityContract: payload.universalObjectIdentityContract,
    namingPolicy: payload.namingPolicy,
  ...
  exportSnapshot(state: RuntimeContentState): GameRuntimeData {
    return {
      metadata: {
        ...
        universalDiscoveryRegistryVersion: state.universalDiscoveryRegistry?.version,
      ...
      economyBehaviorContracts: state.economyBehaviorContracts,
      eraEconomyProfiles: state.eraEconomyProfiles,
      economyUsageRelationships: state.economyUsageRelationships,
      inventoryResourceMetadata: state.inventoryResourceMetadata,
      resourceProducerDefinitions: state.resourceProducerDefinitions,
      buildingResourceEffects: state.buildingResourceEffects,
      economyScopeRules: state.economyScopeRules,
      economyTransactionReasons: state.economyTransactionReasons,
      economyRateBreakdownDefinitions: state.economyRateBreakdownDefinitions,
      offlineProgressionPolicies: state.offlineProgressionPolicies,
      economyCalculationRules: state.economyCalculationRules,
      discoveryCategories: state.discoveryCategories,
      discoverySubcategories: state.discoverySubcategories,
      discoveryRarities: state.discoveryRarities,
      ...
      discoverySpawnProfiles: state.discoverySpawnProfiles,
      discoverySpawnTables: state.discoverySpawnTables,
      discoveryScanProfiles: state.discoveryScanProfiles,
      discoveryCollectionProfiles: state.discoveryCollectionProfiles,
      discoveryRewardProfiles: state.discoveryRewardProfiles,
      discoveryStateDefinitions: state.discoveryStateDefinitions,
      universalDiscoveryRegistry: state.universalDiscoveryRegistry,
      universalObjectIdentityContract: state.universalObjectIdentityContract,
      namingPolicy: state.namingPolicy,
      attributionPolicy: state.attributionPolicy
    };
  }
}
